...
proc create_ipi_design { offsetfile design_name } {
	...
	set myip_0 [ create_bd_cell -type ip -vlnv aptiv.com:user:myip:1.0 myip_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores aptiv.com:user:myip:1.0]]]]
